...
public class MemoryUtils {
  ...
  /**
   * @return The current heap usage as a decimal number between 0.0 and 1.0. That is, if the
   *     returned value is 0.85, 85% of the max heap is used.
   *     <p>If no max heap is set, the method returns -1.0.
   */
